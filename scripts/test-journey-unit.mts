...
assert(
  firstHoldingNext.label === "Add first holding",
  "working budget with no holdings next is Add first holding",
);
...
assert(
  freedomNext.label === "Start a Freedom plan",
  "book without a Freedom plan next is Start a Freedom plan",
);
assert(freedomNext.href === "/freedom?tab=do", "Freedom plan starts on Freedom Do");
