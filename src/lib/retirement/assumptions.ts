...
export const RETIRE_ENGINE_ASSUMPTIONS: readonly string[] = [
  ...
  "The minimum is the prescribed factor for the age attained that year, times the account value at the start of the year, before growth. Before 71 the factor is 1/(90−age). Ages 71–94 use the federal percents published since 2015. From 95 on the factor is 20%.",
  ...
  "In the survivor view, death takes effect at the start of the year that person reaches the age you enter. Their accounts transfer to the survivor before growth. Later RRIF minimums use the survivor's age. The view does not model a CPP survivor pension, the OAS allowance for the survivor, or a smaller household budget.",
