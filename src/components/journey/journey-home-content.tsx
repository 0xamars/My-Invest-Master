...
import { JOURNEY_HOME_STATUS_LABELS, TRACK_LABELS } from "@/lib/journey/labels";
...
export function JourneyHomeContent() {
  ...
  const nextLesson = nextLessonFromProgress(liveProfile);
  ...
  return (
    <div className="flex flex-1 flex-col gap-8">
      <div>
        ...
        <h1 className="page-title mt-4">Your path</h1>
      ...
      {nextLesson ? (
        <div className="surface-card px-5 py-5">
          ...
          <p className="mt-1 text-base font-semibold tracking-tight">
            <Link href={nextLesson.href} className="hover:underline">
              {nextLesson.title}
            </Link>
          </p>
        </div>
